                ...
                {loading ? (
                  <div className="flex animate-pulse items-center space-x-4">
                    ...
                    <div className="ml-4 flex-shrink-0">
                      <button className="ml-4 rounded-md px-3 py-1 text-indigo-600 transition duration-150 hover:bg-indigo-100 hover:text-indigo-500 active:bg-indigo-200 active:text-indigo-700">
                        Download
                      </button>
                    </div>
                  </div>
                  ...
                  >
                    <li className="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                      ...
                      <div className="ml-4 flex-shrink-0">
                        {/* <button
                            onClick={() => DownloadPDF(order.orderDetails.id)}
